...
public class LoggingAspect {
    ...
    /**
     * A pointcut expression for methods in the service layer (i.e. classes in the by.a1.unauthorizeddeliveries.service.impl package).
     */
    @Pointcut("execution(* by.a1.unauthorizeddeliveries.service.impl.*.*(*))")
    public void inServiceLayer() {}


    /**
     * A pointcut expression for methods in the controller layer (i.e. classes in the by.a1.unauthorizeddeliveries.controller package).
     */
    @Pointcut("execution(* by.a1.unauthorizeddeliveries.controller.*.*(*))")
    ...
    /**
     * An after-throwing advice to be executed after methods in the service layer throw a ServiceException.
    ...
    public void afterThrowing(ServiceException exception) {
